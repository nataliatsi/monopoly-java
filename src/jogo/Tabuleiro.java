...
public class Tabuleiro {
    ...
    private void inicializarCasas(){
        ...
        casas.add(new Sorte(2, "Cofre Comunitário 1"));
        casas.add(new Propriedade(3, "Baltic Avenue", "roxo", 60,  4, 20, 60, 180, 320, 450, 30, 50));
        casas.add(new CofreComunitario(4, "Income Tax"));
        ...
        casas.add(new CofreComunitario(7, "Chance 1"));
        ...
        casas.add(new CofreComunitario(10, "Jail Just Visiting"));
        ...
        casas.add(new Sorte(17, "Cofre Comunitário 2"));
        ...
        casas.add(new CofreComunitario(20, "Free Parking"));
        casas.add(new Propriedade(21, "Kentucky Avenue", "vermelho", 220, 18, 90, 250, 700, 875, 1050, 110, 150));
        casas.add(new CofreComunitario(22, "Chance 2"));
        ...
        casas.add(new CofreComunitario(30, "Vá para Prisão"));
        ...
        casas.add(new CofreComunitario(33, "Community Chest 3"));
        ...
        casas.add(new CofreComunitario(36, "Chance 3"));
        casas.add(new Propriedade(37, "Park Place", "azul", 350, 35, 175, 500, 1100, 1300, 1500, 175, 200));
        casas.add(new CofreComunitario(38, "Luxury Tax"));
