...
public class Sorte extends Casa {
    ...
    private void inicializarCartas() {
        cartas.add(new Mover(1, "Avance para o Ponto de Partida (Go)", "Receba $200", "Isso não é um bônus, ou seja, os $200 referem-se ao valor que o jogador recebe normalmente ao passar pelo Ponto de Partida. Importante: veja a regra acima marcada com um *", 40, true));
        ...
        cartas.add(new Mover(7, "Vá para a Prisão", "Vá direto para a prisão – Não passe pelo ponto de partida – Não receba $200", "", 30, false));
        ...
        cartas.add(new Pagar(16, "Você Deve cartas.Pagar os Reparos da Rua", "Pague $40 por cada casa, $115 por hotel", "Isso se aplica apenas às casas e hotéis que o jogador possui; ele não precisa pagar pelas casas e hotéis dos outros jogadores.", 150));
    }
