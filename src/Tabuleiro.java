...
public class Tabuleiro {
    ...
    private void inicializarCasas(){
        ...
        casas.add(new CasaTeste(2, "Community Chest 1"));
        ...
        casas.add(new CasaTeste(7, "Chance 1"));
        ...
        casas.add(new CasaTeste(10, "Jail Just Visiting"));
        casas.add(new Propriedade(11, "St. Charles Place", "rosa", 140, 10, 50,150, 450, 625, 750, 70, 100));
        casas.add(new CasaTeste(12, "Eletric Company"));
        ...
        casas.add(new CasaTeste(17, "Community Chest 2"));
        ...
        casas.add(new CasaTeste(22, "Chance 2"));
        ...
        casas.add(new CasaTeste(33, "Community Chest 3"));
        ...
        casas.add(new CasaTeste(36, "Chance 3"));
